    ...
    <div className="min-h-screen bg-gradient-to-br from-muted via-background to-primary/5 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-serif font-bold text-foreground mb-3">Join Trust Trace</h1>
          <p className="text-muted-foreground text-lg">Create your account and start tracing food quality</p>
        </div>
        <SignupForm />
      </div>
    </div>
